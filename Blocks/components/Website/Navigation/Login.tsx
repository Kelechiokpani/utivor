        ...
        <>
            <div className="flex">
                ...
                <div className="surface-section w-full md:w-6 p-6 md:p-8">
                    <div className="mb-5">
                        <Logo_Import/>
                        <div className="text-900 text-3xl font-medium mb-3">Login to Continue</div>
                        <span className="text-600 font-medium mr-2">Don't have an account?</span>
                        <a href='/register' className="font-medium no-underline text-orange-600 cursor-pointer">Sign in!</a>
                    </div>
...
const Body_Style = styled.div`
  //background:url("../../../public/website/navigation/img.png");
